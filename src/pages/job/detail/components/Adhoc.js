  ...
  return (
    ...
    <Descriptions title={jobInfo.name}
      ...
      >
        ...
        <Descriptions.Item label="Become method">{extra.become_method || 'None'}</Descriptions.Item>
        ...
        <Descriptions.Item label="Verbosity">{template.verbosity || 0}</Descriptions.Item>
        <Descriptions.Item label="Notification">{extra.Notification || null}</Descriptions.Item>
        ...
        <Descriptions.Item label="Extra options" span={2}>
          <div>{template.extraOptions ? StringObject(template.extraOptions) : null}</div>
        </Descriptions.Item>
